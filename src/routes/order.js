...
import { createOrder, getOrderById, getUserOrders, getAllOrders, updateDeliveryStatus } from '../controllers/Orders/orders.js'
...
// update order status
router.patch('/update-status/:id', authorizeUser, updateDeliveryStatus)
